...
# Локации живут по другим правилам, чем объявления: у объявления есть цена
# и срок жизни, у места — нет. Поэтому они не мешаются в общей ленте, а
# составляют отдельный раздел справочника.
LOCATION = "location"

# Разделы объявлений — всё, кроме локаций. Порядок задаёт порядок вкладок:
# сначала то, ради чего справочник затевался.
ADS = ["rent", "sale", "jobs", "services", "goods", "transport", "food", "events", "other"]
